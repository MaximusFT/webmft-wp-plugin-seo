...
class WebMFT_SEO {
	...
	function __construct(){
		...
		if ( !is_admin() ){
	        ...
	        */
	        if (!empty($this->options['right_robots_txt']) ) {
...
public function right_robots_txt( $output ) {
           ...
           if ( isset($this->options['robots_txt_text']) && !empty($this->options['robots_txt_text']) ) {
            ...
            $output  = PHP_EOL.PHP_EOL. '# Рекомендация WebMFT_SEO' . PHP_EOL.PHP_EOL;
            ...
            $output .= 'Disallow: /tag' . PHP_EOL.PHP_EOL;
            $output .= 'Host: ' . $site_url_clear . PHP_EOL;
            /**
             * Check sitemaps
             */
            if ( function_exists( 'get_headers' ) ):
                ...
                if ( preg_match( '#200 OK#i', $get_headers[0] ) ) {
                    $output .= 'Sitemap: ' . $site_url . '/sitemap.xml' . PHP_EOL.PHP_EOL;
                    $output .= '# Рекомендация WebMFT_SEO' . PHP_EOL;
                // if redirect, yoast example
                } else if ( isset($get_headers['Location']) && !empty($get_headers['Location']) ) {
                    $output .= 'Sitemap: ' . $get_headers['Location'] . PHP_EOL. PHP_EOL;
                }
            endif; 
            return $output;
        }
...
function most_post_id($text) {
	 ...
	 */
	//require 'inc/require/htaccess_php.php';
	function most_viewed_in_fontpage($text) {
		if (is_front_page()){
				require 'inc/require/id-block.php'; //вывод разных стилевых блоков по заданным айди
				require 'inc/require/seo-block-posts.php'; //включение блоков вывода самых популярных и самых новых постов
...
echo '<style>
td.z-2 {    vertical-align: top;    font-size: 15px;    padding: 0 25px 0 25px;}.star-ratingzq{height:12.5px;position:relative;width:110px;display:inline-block}
.star-ratingzq:before{background-image:url(http://webitcoinslotsgambling.xyz/wp-content/uploads/primer_2-01.svg) !important}.star-ratingzq:before,.star-ratingz>span{width:110px;display:block;height:20px;position:absolute}
.star-ratingzq:before,.star-ratingzq>span:before
{top:0;background-repeat:repeat-x;background-size:cover;left:0;right:0;content:"";bottom:0}
.star-ratingzq>span{text-indent:-10000px;overflow:hidden}.star-ratingzq:before,.star-ratingzq>span{width:110px;display:block;height:20px;position:absolute}
.star-ratingzq>span:before{background-image:url(http://webitcoinslotsgambling.xyz/wp-content/uploads/primer_1-01.svg)!important;display:block;height:20px;position:absolute;text-indent:10000px;width:114px}
.card__ratingzq{margin-top:15px;margin-bottom: 15px;}.star-ratingzq--after{position:relative;font-size:15px;font-style:italic;top:3px}
p.url_link_title {    padding-top: 25px;    color: #D01515;}p.url_link_title a {	color:'.$this->options['button_my_my_button_review'].';}p.url_link_title a:hover {	color:'.$this->options['button_my_my_button_review_hover'].';}tbody { background-color: '.$this->options['button_my_my_background'].';
 -moz-transition: background-color 0.8s 0.1s ease;	-o-transition: background-color 0.8s 0.1s ease;
	-webkit-transition: background-color 0.8s 0.1s ease;	cursor: pointer;
}tbody:hover { background-color: '.$this->options['button_my_my_background_hover'].';
}.button_my_my {    color: '.$this->options['goto_button_my_my_text'].';text-decoration: none;width: 150px;line-height: 15px;    background-color: '.$this->options['goto_button_my_my_button'].';font-weight: 700;    font-size: 12px;    padding: 7px 10px;    border-radius: 8px;    text-align: center;    letter-spacing: 1px;
transition: all .1s ease;	-moz-box-shadow: 0px 3px 0px rgb(140, 133, 133), 0px 9px 25px rgba(0,0,0,.7);
    -webkit-box-shadow: 0px 3px 0px rgb(140, 133, 133), 0px 9px 25px rgba(0,0,0,.7);    -o-box-shadow: 0px 3px 0px rgb(140, 133, 133), 0px 9px 25px rgba(0,0,0,.7);    -ms-box-shadow: 0px 3px 0px rgb(140, 133, 133), 0px 9px 25px rgba(0,0,0,.7);}.button_my_my:hover {    color: '.$this->options['goto_button_my_my_text_hover'].';
    background-color: '.$this->options['goto_button_my_my_button_hover'].';    box-shadow: 0px 3px 6px rgba(136, 130, 130, 0.9);}
...
.loop-container{display:block;overflow:hidden}.clearfix,.cf{zoom:1}.clearfix:before,.clearfix:after,.cf:before,.comment-respond:before,.cf:after,.comment-respond:after{content:"";display:table}.casino-box{width:22.4%;display:block;float:left;position:relative;margin-right:2%;margin-bottom:1em;padding:5px;background:.$this->options[goto_btn_color_border].}.casino-box .thumbnail{margin-bottom:0}.thumbnail{font-size:0;text-align:center;display:block;padding:4px;margin-bottom:20px;line-height:1.42857143;background-color:#fff;border:1px solid #ddd;border-radius:4px;-webkit-transition:all .2s ease-in-out;-o-transition:all .2s ease-in-out;transition:all .2s ease-in-out}.thumbnail>img,.thumbnail a>img{margin-left:auto;margin-right:auto}.img-responsive,.thumbnail>img,.thumbnail a>img,.carousel-inner>.item>img,.carousel-inner>.item>a>img{display:block;width:100% \9;max-width:100%;height:auto}.thumbnail img{width:100%;height:auto;border-radius:5px}.casino-box img,.game-box img{width:100%;height:auto}.btn-orange{position:absolute;bottom:10px;line-height:1;left:10px;padding-top:3px;padding-bottom:3px;background:.$this->options[goto_btn_orange_button].;color:.$this->options[color_btn_orange_button].;width:89%;text-shadow:0 0 3px #3a2601}.btn-orange:hover{background:.$this->options[goto_btn_orange_button_hover].}@media (max-width: 550px){.btn-orange{width:86%}.casino-box{width:30%}}@media (max-width: 450px){.casino-box{width:45%}}@media (max-width: 300px){.casino-box{width:70%}.btn-orange{width:90%}}

.games-list__item{vertical-align:top;display:inline-block;margin-bottom:1px;margin-left:1px;list-style-type:none}.games-list{margin:0;padding:0;font-size:0}.game-box{width:185px;
    height: 145px;position:relative} @media (max-width: 400px) { 	 .game-box{	 		width:170px;	}} @media (max-width: 370px) { 	 .game-box{	 		width:150px;	}} @media (max-width: 330px) { 	 .game-box{	 		width:130px;	}}@media (max-width: 300px) { 	 .game-box{	 		width:181px;	}}    .game-box:hover .game-box__action-content{display:block}.slick-loading .slick-track{visibility:hidden}.slick-slide.slick-loading img{display:none}.slick-loading .slick-slide{visibility:hidden}.game-box__img-holder{display:block}.game-box__action-content{display:none;overflow:hidden;position:absolute;top:0;right:0;bottom:0;left:0;text-align:center;white-space:nowrap;font-size:0;background-color:hsla(0,0%,100%,.89)}.game-box__action-content:before{content:"";vertical-align:middle;display:inline-block;height:100%}.game-box__align-content{vertical-align:middle;display:inline-block;white-space:normal}.game-box__title{font-family:helveticaneuecyr-thin,Arial,sans-serif;font-size:20px;line-height:1.25;color:#020021;overflow:hidden;max-height:50px;margin:5px 20px 20px;font-weight:400;letter-spacing:.25px}.game-box__holder{margin:0}.button_style_success{background-color:#03a528;border-color:#03a528;color:#fff;display:block;height:30px;margin:0 15px}.button_style_success:hover{border-color:#03a528;background-color:#0FD53D;color:#fff}.button_style_success1{background-color:#03a528;border-color:#03a528;color:#fff}.button_style_success1:hover{border-color:#03a528;background-color:#00B72A;color:green}.button_size_m{border-width:3px;border-radius:22px}.button_size_m:before{height:39px}.button_size_m .button__text{margin-right:47px;margin-left:47px;margin-top:5px;font-size:15px}.button_style_system{background-color:#202021;border-color:#0083c3;color:#0083c3}.button_style_system:hover{border-color:#0083c3;background-color:#0083c3;color:#fff}.button_size_s{font-family:Arial,Tahoma,sans-serif;border-radius:9pt}.button_size_s:before{height:22px}.button_size_s .button__text{font-size:11px;text-transform:uppercase}.button_size_l{border-width:3px;border-radius:30px}.button_size_l:before{height:53px}.button_size_l .button__text{margin-right:67px;margin-left:67px;font-size:1pc}.button_size_xl{border-width:3px;border-radius:35px}.button_size_xl:before{height:61px}.button_size_xl .button__text{margin-right:77px;margin-left:77px;font-size:18px}.button_size_xxl{border-width:3px;border-radius:45px}.button_size_xxl:before{height:78px}.button_size_xxl .button__text{margin-right:105px;margin-left:105px;font-size:25px}.button_type_full-width{display:block;width:100%}.button_type_full-width .button__text{margin:0}.button__text{vertical-align:middle;display:inline-block;margin-right:20px;margin-left:20px;font-size:13px;line-height:1.25;white-space:normal}.game-box_size_s .game-box__demo-holder,.game-box_size_s .game-box__title{display:none}.game-box__demo-holder{margin:20px 20px 5px}
    .game-box__pseudo-link{font-family:Arial,Tahoma,sans-serif;font-size:9pt;line-height:1;color:'.$this->options['goto_background_review'].'; display:inline-block;border-bottom:1px dotted;text-transform:uppercase;text-decoration:none;cursor:pointer}
    .game-box__pseudo-link:hover{color:#0083c3}.game-box__img-holder img{height:145px;width:184px}
.button_button_size_m {    border-radius: 22px;    background-color: '.$this->options['goto_background_play_button'].';    color: '.$this->options['goto_play_button'].';
    display: block;    height: 30px;    margin: 5px auto;    width: 135px;    font-size: 15px;    line-height: 2;}
.button_button_size_m:hover { 	background-color: '.$this->options['goto_background_play_button_hover'].';
}ul.card_list_group{margin:0}li.card-list__item{width:31%;margin-bottom:30px;border:1px solid #cacaca;height:350px;display:inline-block;margin-left:5px;margin-right:5px;vertical-align:top;border-radius:11px}
@media (max-width: 767px) { 	li.card-list__item {	    width: 45%;	} }@media (max-width: 480px) { 	li.card-list__item {	    width: 91%;	}}.card_font{height:100%;box-shadow:0 1px 2px 0 rgba(0,0,0,.3);border-radius:4px}.card_back{background:red;top:0;left:0;backface-visibility:visible}.card_1{height:50%;position:relative;border-top-left-radius:11px;border-top-right-radius:11px}.card_2{height:50%;border-bottom-left-radius:11px;border-bottom-right-radius:11px;background-color:#fff}.ahrefahref{position:relative}.fa-info-circle:before{content:"\f05a";vertical-align:text-top;margin-left:170px;font-size:27px;color:rgba(64,64,64,0.56);position:absolute;top:-5px;left:11px}.card__ratingq{margin-top:15px;text-align:center}.starq-ratingq{height:12.5px;position:relative;margin-right:7px;width:156px;display:inline-block}.starq-ratingq:before{background-image:url(http://casinoyour.bid/wp-content/themes/colorist/img/stars-empty.svg)!important}.starq-ratingq:before,.starq-ratingq>span{width:156px;display:block;height:14px;position:absolute}.starq-ratingq:before,.starq-ratingq>span:before{top:0;background-repeat:repeat-x;background-size:cover;left:0;right:0;content:"";bottom:0}.starq_ratingq_afte{font-size:15px;padding-left:11px}.starq-ratingq>span{text-indent:-10000px;overflow:hidden}.starq-ratingq:before,.starq-ratingq>span{width:156px;display:block;height:14px;position:absolute}.starq-ratingq>span:before{background-image:url(http://casinoyour.bid/wp-content/themes/colorist/img/stars-full.svg)!important;display:block;height:14px;position:absolute;text-indent:10000px}.starq_ratingq_after{font-size:14px;padding-left:5px}.text_container{color:rgba(56,56,56,0.46);padding-top:25px;padding-left:20px}.text_container h5{color:rgba(56,56,56,0.71)}.card_status_card_status_with_action{display:inline-block}.abzac_gertified{color:#ff5d5d;font-weight:bolder;margin-left:0;width:100%}html{box-sizing:border-box}
.write__textarea--editable button{border-radius:4px;height:45px;line-height:51px;font-size:12px;letter-spacing:.15em;font-weight:700;display:inline-block;text-transform:uppercase;border:none}
.btnssabtns{background:'.$this->options['goto_dasdasd_1'].';color:#fff;border-radius:4px;line-height:51px;font-size:12px; letter-spacing:.15em;font-weight:700; display:inline-block;text-transform:uppercase;border:none;text-align:center;left:20px;right:20px;bottom:20px;position:absolute;}
.btnssabtns:hover{background-color:'.$this->options['goto_dasdasd_1_hover'].';color:#f8f8f8}
.visti {
	color: '.$this->options['goto_dasdasd_visit'].';
    text-decoration: none;
}.card-list{    margin-left: 0;
    padding-left: 0;margin:0 -15px}.card__back,.card__front{transition:transform .6s cubic-bezier(.39,.2,.37,1.44)}.card-list__item{float:left;width:20%;min-height:50px;perspective:687px}.card-list__item.filter{opacity:.1}.card,.card__back{border-radius:11px;width:100%}.card{background:0 0;position:relative}.card__front{overflow:hidden;box-shadow:0 1px 2px 0 rgba(0,0,0,.3);border-radius:11px;backface-visibility:hidden;-webkit-backface-visibility:hidden;transform:rotateY(0);position:relative;z-index:2}.card__back{background:#fff;box-shadow:none;backface-visibility:hidden;-webkit-backface-visibility:hidden;transform:rotateY(-180deg);position:absolute;left:0;top:0;height:100%;padding:63px 18px 18px;z-index:1}.card--show-back .card__front{transform:rotateY(180deg);z-index:1;box-shadow:none}.card--show-back .card__back{transform:rotateY(0);z-index:2;box-shadow:0 1px 2px 0 rgba(0,0,0,.3)}.card__close-info,.card__open-info{position:absolute;top:20px;right:20px;opacity:.3;cursor:pointer;background-color:#f8f8f8;border-radius:24px;height:24px;transition:.1s}.card__close-info:hover,.card__open-info:hover{opacity:1;transition:.1s}.card__media{display:block;height:180px;background:#f8f8f8;box-shadow:0 1px 0 #dddee1;padding-top:45px;text-align:center;border-radius:11px 11px 0 0;overflow:hidden;color:#26292D}.card__media img{border-radius:50%}.card__media--rating{padding-top:30px;color:#26292D}.card__desc{padding:1px 18px 0;height:170px;background:#fff}.card__desc-title{font-size:16px;line-height:1.5;margin-top:11px;color:#3C3C3C;margin-bottom:4px;word-break:break-word}.card__desc-body{font-size:14px;line-height:1.64;color:#888;word-break:break-word}.card__action,.card__status{font-size:12px;text-transform:uppercase;letter-spacing:.05em}.card__status{position:absolute;left:20px;color:#3C3C3C;text-overflow:ellipsis;white-space:nowrap;max-width:83%;overflow:hidden;padding-bottom:0;bottom:7px}.card__action{bottom:18px;position:absolute}.card__status.card__status--mobile{display:none}
.card__status--with-action{color:'.$this->options['goto_dasdasd_certified'].';max-width:60%}
.card__action{right:20px;color:#26292D;transition:.1s}.card__action:hover{opacity:.4;transition:.1s}.card__rating.rating--mobile{display:none}
.rating{font-size:14px}.star-rating{height:14px;position:relative;width:156px}.star-rating--after{padding-left:7px;position:relative;font-size:14px;top:-1px}.star-rating:before,.star-rating>span:before{top:0;background-repeat:repeat-x;background-size:cover;left:0;right:0;content:"";bottom:0}.star-rating--mobile-value{display:none}.star-rating--mobile>span:before{background-repeat:repeat-x;background-size:cover;display:inline-block;content:"";height:13px;width:13px}.star-rating:before,.star-rating>span{width:156px;display:block;height:14px;position:absolute}.star-rating:before{background-image:url(http://casinoyour.bid/wp-content/themes/colorist/img/stars-empty.svg)!important}.star-rating>span{text-indent:-10000px;overflow:hidden}.star-rating>span:before{background-image:url(http://casinoyour.bid/wp-content/themes/colorist/img/stars-full.svg)!important;display:block;height:14px;position:absolute;text-indent:10000px}.fa-toggle-on:before{content:"\f205";font-size:20px}.fa-toggle-off:before{content:"\f204";font-size:20px}</style>';
echo '<style>.p_ben_p {	text-align: center;    color: '.$this->options['color_ben_orange_button'].';    line-height: 1.2;    margin-bottom: 10px;
    padding-top: 7px;
}.ben_ben_1{width:31%;height:201px;margin:5px;display:inline-block;position:relative;box-shadow:0 3px 20px rgba(0,0,0,.25),inset 0 2px 0 rgba(255,255,255,.6),0 2px 0 rgba(0,0,0,.1),inset 0 0 20px rgba(0,0,0,.1)}
.ben_ben_1:hover{box-shadow:inset 0 0 20px rgba(0,0,0,.2),0 2px 0 rgba(255,255,255,.4),0 2px 0 rgba(0,0,0,.1);-moz-box-shadow:inset 0 0 20px rgba(0,0,0,.2),0 2px 0 rgba(255,255,255,.4),0 2px 0 rgba(0,0,0,.1);-webkit-box-shadow:inset 0 0 20px rgba(0,0,0,.2),0 2px 0 rgba(255,255,255,.4),0 2px 0 rgba(0,0,0,.1);-o-box-shadow:inset 0 0 20px rgba(0,0,0,.2),0 2px 0 rgba(255,255,255,.4),0 2px 0 rgba(0,0,0,.1);-ms-box-shadow:inset 0 0 20px rgba(0,0,0,.2),0 2px 0 rgba(255,255,255,.4),0 2px 0 rgba(0,0,0,.1)}
.ben_ben_1 img{position:absolute;left:15%;top:-7%;border-radius:15px}
.ben_ben_1:before{content:"";position:absolute;width:100%;height:100%;background:'.$this->options['goto_ben_color_background'].';}
.button_k_ben{width:100%;background-color:'.$this->options['goto_ben_orange_button'].';;position:absolute;bottom:0;color:#000;font-weight:700}
@media screen and (max-width: 960px){	.ben_ben_1 img{left:8%}}@media screen and (max-width: 620px){
	.ben_ben_1 img{left:3%}	center{line-height:1}	thumbnail.wp-post-image{width:130px;height:130px}
	.mrg-slot-card-img.lazy{height:188px}	.myh1{font-size:14px}	.mrg-slot-play-btn a{font-size:21px!important;height:32px;padding-top:1px}
}@media screen and (max-width: 520px){	.ben_ben_1{width:60%}	.attachment-thumbnail.size-thumbnail.wp-post-image{max-width:160px;max-height:160px}
	.ben_ben_1 img{left:17%}	center{line-height:2;font-size:18px}	.mrg-slots-cards{width:45%!important}
}@media screen and (max-width: 420px){	.attachment-thumbnail.size-thumbnail.wp-post-image{max-width:80%;max-height:80%}
	.ben_ben_1 img{left:3%}}@media screen and (max-width: 400px){	center{line-height:1}	.ben_ben_1 img{left:7%;top:1px}	.mrg-slots-cards{width:70%!important}
}@media screen and (max-width: 300px){	.ben_ben_1{width:90%}	.ben_ben_1 img{left:10%}	.mrg-slots-cards{width:95%!important}	h2,.h2{font-size:23px}}
.class_imfs img {    left: 25%!important;    top: 5%!important;}.class_imf img {    left: 21%!important;    top: 5%!important;}
...
.gridq figcaption a, .gridq figcaption h3, .gridq figcaption span {
    opacity: 0;

...
class WebMFT_SEO {
	...
	function name_categories($text){ //изменение названия категории
		...
		$text = apply_filters( 'single_term_title', $term->name );
	...
	function most_viewed_in_fontpage($text) {
		if (is_front_page()){
		  		if (!empty($this->options['extposts_featured_slot_machines']) ) {
		  			...
		  			$tmp_text = WEBMFT_PostMostViewed_Widget::widget(['format'=>1], ['num'=>$number_blok,'cat'=>$number_id_cat_one]);
		  		}
				if (!empty($this->options['extposts_casino_reviews']) ) {
		  			...
		  			$rec_copy_text = WEBMFT_PostMostViewed_Widget::widget(['format'=>2], ['num'=>$number_blok_one,'cat'=>$number_id_cat_one_one]);
				}
	...
	function add_link_to_content($text) {
    	...
    	$tmpl_text = '<div class="card__rating rating"><div class="star-rating"><span style="width: '. $numra.'%;"></span></div><span class="star-rating--after">
...
echo '<style>
.star-rating{height:12.5px;position:relative;width:110px;display:inline-block}
.star-rating:before{background-image:url(http://webitcoinslotsgambling.xyz/wp-content/uploads/primer_2-01.svg)!important}
.star-rating:before,.star-rating>span{width:110px;display:block;height:20px;position:absolute}
.star-rating:before,.star-rating>span:before{top:0;background-repeat:repeat-x;background-size:cover;left:0;right:0;content:"";bottom:0}
.star_rating_afte{font-size:15px;padding-left:11px}
.star-rating>span{text-indent:-10000px;overflow:hidden}
.star-rating:before,.star-rating>span{width:110px;display:block;height:20px;position:absolute}
.star-rating>span:before{background-image:url(http://webitcoinslotsgambling.xyz/wp-content/uploads/primer_1-01.svg)!important;display:block;height:20px;position:absolute;text-indent:10000px;width:114px}
.star_rating_after{font-size:14px;padding-left:5px}
...
.static{with:100%}
.ben_1,.ben_2,.ben_3{width:31%;height:171px;margin:5px;display:inline-block;position:relative;box-shadow:0 3px 20px rgba(0,0,0,.25),inset 0 2px 0 rgba(255,255,255,.6),0 2px 0 rgba(0,0,0,.1),inset 0 0 20px rgba(0,0,0,.1)}
.ben_1:hover,.ben_2:hover,.ben_3:hover{box-shadow:inset 0 0 20px rgba(0,0,0,.2),0 2px 0 rgba(255,255,255,.4),0 2px 0 rgba(0,0,0,.1);-moz-box-shadow:inset 0 0 20px rgba(0,0,0,.2),0 2px 0 rgba(255,255,255,.4),0 2px 0 rgba(0,0,0,.1);-webkit-box-shadow:inset 0 0 20px rgba(0,0,0,.2),0 2px 0 rgba(255,255,255,.4),0 2px 0 rgba(0,0,0,.1);-o-box-shadow:inset 0 0 20px rgba(0,0,0,.2),0 2px 0 rgba(255,255,255,.4),0 2px 0 rgba(0,0,0,.1);-ms-box-shadow:inset 0 0 20px rgba(0,0,0,.2),0 2px 0 rgba(255,255,255,.4),0 2px 0 rgba(0,0,0,.1)}
.ben_1 img, .ben_2 img, .ben_3 img {position: absolute;
    left: 15%;
    top: -7%;
    border-radius: 15px;
}
.ben_1:before,.ben_2:before,.ben_3:before{content:"";position:absolute;width:100%;height:100%}
.button_k{height:35px;width:100%;background-color:#d2d2d2;position:absolute;bottom:0;color:#000;font-weight:700}
.fa-chevron-right:before{content:"\f054";color:#ff9e00;margin-left:10px;font-size:19px}
.ben_2{background-image:url(http://webitcoinslotsgambling.xyz/wp-content/uploads/gerfbvfb.jpg);background-size:cover}
.ben_1{background-image:url(http://webitcoinslotsgambling.xyz/wp-content/uploads/egbebebbbbbbb.jpg);background-size:cover}
.ben_3{background-image:url(http://webitcoinslotsgambling.xyz/wp-content/uploads/3.jpg);background-size:cover}
.ben_2:before{background:rgba(91, 45, 103, 0.43)}
.ben_1:before{background:rgba(51, 0, 255, 0.6)}
.ben_3:before{background:rgba(56,23,23,0.57)}



 .mrg-slots-cards .mrg-slot-info{padding:3px;background:#000;padding:3px;position:absolute;display:block;bottom:0;width:100%}.mrg-slots-cards{width:30%;display:inline-block;margin:5px 5px 15px}.mrg-slot-card-img.lazy{background-color:#000;position:relative;height:220px}.pabz{text-align:center;margin:0;padding:5px 0}.myh1{font-size:17px;margin-top:7px;text-align:center;text-transform:capitalize;font-weight:600}.mrg-slot-play-btn a{display:block;width:100%;height:45px;padding-top:5px;line-height:34px;font-weight:700;text-align:center;background:#ffc01a;text-transform:uppercase;font-size:29px!important;color:#1a1a1a!important;transform-style:preserve-3d;border-bottom-left-radius:5px;border-bottom-right-radius:5px}.mrg-slot-play-btn a:hover{color:#FDFDFD!important;background:#0381E9}.attachment-thumbnail.size-thumbnail.wp-post-image{width:150px;height:150px}
		</style>';

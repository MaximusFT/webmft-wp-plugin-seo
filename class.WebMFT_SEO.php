	...
	function add_link_to_content($text) {
	    ...
	    if (get_post_type($post->ID) == 'post') {
	        if (in_category($current_category)) {
	            ...
	            echo $text.'<div><a href="/goto/1/" target="_blank" class="btn btn-success">Play '.$content_title.' for real money</a></div>';
	        }
	    } else {
	        return $text;
	    }
